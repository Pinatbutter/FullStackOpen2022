describe('Blog app', function() {
  ...
  describe('When viewing blog list', function() {
    beforeEach(function() {
      cy.login({ username: 'Milwalke', password: 'correct' })
      cy.createBlog({ title: 'Blog Creation Works', author: 'Pina', url: 'dotcom.com' })
    })
    ...
    it('Blogs are ordered according to likes', function() {
      cy.createBlog({ title: 'Im the least liked blog', author: 'Noone', url: 'dotcom.com' })
      cy.createBlog({ title: 'Most liked blog', author: 'Pina', url: 'dotcom.com' })
